...
<body>
    ...
    <nav class="navbar navbar-default navbar-static-top banner" style="margin-bottom: 0px;">
        <div class="container">
                    ...
                    @else
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li>
                                    <a href='/newpost' style="color: #558">
                                        New Post
                                    </a>
                                </li>
                                <li>
                                    <a href='/home?author_id={{ Auth::user()->id}}' style="color: #558">
                                        My Posts
                                    </a>
                                </li>
